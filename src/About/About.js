    ...
    return (
      <section className="About">
        ...
        <p className="about-paragraph">
          <br /> I had a dream that I was married to a one-eyed ogre and I was
          like, "Why am I married to you?" The ogre answered, "You're married to
          me because you wear a necklace with an eye on it which symbolizes my
          missing eye." At that point, I found the necklace and put it on. The
          ogre clapped and said, "There you go!!"
          <br />
          <br />
          <em>-Iva Yos</em>
        </p>
        <p className="about-paragraph">
          I know it’s been a rough year for everyone, but I can’t help but
          notice that no one has checked in on me. To begin with, I’m never seen
          as an individual. Always a pair. But I’m my own eye. I have my own
          needs, my own dreams, my own life. Also, I’m always the one expected
          to be doing the seeing, but I can’t even remember the last time anyone
          saw me. Like, ACTUALLY saw me. And I was feeling all of this before
